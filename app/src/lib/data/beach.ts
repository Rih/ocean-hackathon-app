...
export const BEACHES: Beach[] = [
    ...
    { id: 2, title: 'Trocadero', lat: -23.5849686, lng: -70.3940418, region: 'Región de Antofagasta', plastic_index: 5.252525, danger_index: 0.42831945, details: 'La Playa Trocadero se encuentra en el norte de Chile, en la ciudad de Antofagasta, la cual tiene una población aproximada de 361,873 habitantes. La playa es conocida por su belleza natural y su ambiente relajante, siendo uno de los destinos más populares para disfrutar del mar y el clima cálido. ' },
